...
public:
    ...
    /**
     * @brief Less than or equal operator (by timestamp)
     * @param other Message to compare with
     * @return true if this message is earlier than or equal to other
     */
    bool operator<=(const LogMessage& other) const;

    /**
     * @brief Greater than or equal operator (by timestamp)
     * @param other Message to compare with
     * @return true if this message is later than or equal to other
     */
    bool operator>=(const LogMessage& other) const;
    ...
    /**
     * @brief Compare content with another message (not just timestamps)
     * @param other Message to compare with
     * @return true if content fields are identical
     */
    bool compareContent(const LogMessage& other) const {
        return LogMessageToolbox::CompareMessageContent(data_, other.data_);
    }

    /**
     * @brief Get detailed information about the message
    ...
    std::string getDetailedInfo() const {
        ...
        ss << "File: " << getFile() << ":" << getLineNumber() << "\n";
        ss << "Type: " << toString() << "\n";
        ss << "ID: " << getId() << "\n";
        ss << "Instance ID: " << getInstanceId() << "\n";
        ss << "Process ID: " << getProcessId() << "\n";
        ss << "Thread ID: " << getThreadId() << "\n";
        ss << "Timestamp: " << getTimestamp().seconds << "." << getTimestamp().microseconds << "\n";
        return ss.str();
    }
};
